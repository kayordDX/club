...
public class FacilityRoleHandler(UserStore userStore, ICurrentFacilityAccessor currentFacilityAccessor, IHttpContextAccessor httpContextAccessor)
    : AuthorizationHandler<FacilityRoleRequirement>
{
    ...
    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, FacilityRoleRequirement requirement)
    {
