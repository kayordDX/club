...
public class PaymentConfiguration : IEntityTypeConfiguration<Payment>
{
    public void Configure(EntityTypeBuilder<Payment> builder)
    {
        ...
        builder.Property(p => p.RedirectUrl).HasMaxLength(4000);

        builder.Property(p => p.FormActionUrl).HasMaxLength(1000);

        builder.Property(p => p.FormFieldsJson).HasColumnType("text");
