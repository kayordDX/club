...
namespace Club.Data.Migrations
{
    ...
    [Migration("20260804132056_OutletSearchVector")]
    partial class OutletSearchVector
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Club.Entities.ContractField", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_contract_field");

                    b.HasIndex("BusinessId")
                        .HasDatabaseName("ix_contract_field_business_id");
            ...
            modelBuilder.Entity("Club.Entities.ContractFieldConfig", b =>
                {
                    ...
                    b.Property<int>("ContractFieldId")
                        .HasColumnType("integer")
                        .HasColumnName("contract_field_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_contract_field_config");

                    b.HasIndex("ContractFieldId")
                        .HasDatabaseName("ix_contract_field_config_contract_field_id");

                    b.HasIndex("ContractId")
                        .HasDatabaseName("ix_contract_field_config_contract_id");
            ...
            modelBuilder.Entity("Club.Entities.ContractField", b =>
                {
                    b.HasOne("Club.Entities.Business", "Business")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_contract_field_business_business_id");
            ...
            modelBuilder.Entity("Club.Entities.ContractFieldConfig", b =>
                {
                    ...
                    b.HasOne("Club.Entities.Contract", "Contract")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_contract_field_config_contract_contract_id");
