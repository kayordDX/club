    ...
    public partial class ContractRefined : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_contract_facility_facility_id",
                table: "contract_facility",
                column: "facility_id");

            migrationBuilder.CreateIndex(
                name: "ix_contract_token_token_id",
                table: "contract_token",
                column: "token_id");

            migrationBuilder.CreateIndex(
                name: "ix_token_token_type_id",
                table: "token",
                column: "token_type_id");

            migrationBuilder.CreateIndex(
                name: "ix_token_type_facility_facility_id",
                table: "token_type_facility",
                column: "facility_id");

            migrationBuilder.CreateIndex(
                name: "ix_wallet_token_token_type_id",
                table: "wallet_token",
                column: "token_type_id");
