...
namespace Club.Data.Migrations
{
    ...
    [Migration("20260316193436_GuestBookingSupport")]
    partial class GuestBookingSupport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Club.Entities.Slot", b =>
                {
                    ...
                    b.HasIndex("SlotGroupId")
                        .HasDatabaseName("ix_slot_slot_group_id");
            ...
            modelBuilder.Entity("Club.Entities.SlotGroup", b =>
                {
                    ...
                    b.Property<bool>("CanBookForGuests")
                        .HasColumnType("boolean")
                        .HasColumnName("can_book_for_guests");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_slot_group");

                    b.HasIndex("FacilityId")
                        .HasDatabaseName("ix_slot_group_facility_id");

                    b.HasIndex("ResourceId")
                        .HasDatabaseName("ix_slot_group_resource_id");
