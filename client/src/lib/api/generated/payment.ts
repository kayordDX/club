...
export const paymentResultGet = async (provider: string, options?: RequestInit): Promise<void> => {
...
export const paymentResultPost = async (provider: string, options?: RequestInit): Promise<void> => {
...
export const paymentCheckout = async (provider: string,
    paymentCheckoutRequest: PaymentCheckoutRequest, options?: RequestInit): Promise<PaymentCheckoutResponse> => {
