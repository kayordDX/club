...
export const getSlotGetContractsQueryOptions = <TData = Awaited<ReturnType<typeof slotGetContracts>>, TError = ErrorType<ErrorResponse | InternalErrorResponse>>(id: string, options?: { query?:Partial<CreateQueryOptions<Awaited<ReturnType<typeof slotGetContracts>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSlotGetContractsQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof slotGetContracts>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function createSlotGetContracts<TData = Awaited<ReturnType<typeof slotGetContracts>>, TError = ErrorType<ErrorResponse | InternalErrorResponse>>(
 id: () =>  string, options?: () => { query?:Partial<CreateQueryOptions<Awaited<ReturnType<typeof slotGetContracts>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient
 ): CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {



  const query = createQuery(() => getSlotGetContractsQueryOptions(id(),options?.()), queryClient) as CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
...
export const getSlotGetAllQueryOptions = <TData = Awaited<ReturnType<typeof slotGetAll>>, TError = ErrorType<ErrorResponse | InternalErrorResponse>>(params: SlotGetAllParams, options?: { query?:Partial<CreateQueryOptions<Awaited<ReturnType<typeof slotGetAll>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSlotGetAllQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof slotGetAll>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function createSlotGetAll<TData = Awaited<ReturnType<typeof slotGetAll>>, TError = ErrorType<ErrorResponse | InternalErrorResponse>>(
 params: () =>  SlotGetAllParams, options?: () => { query?:Partial<CreateQueryOptions<Awaited<ReturnType<typeof slotGetAll>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient
 ): CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {



  const query = createQuery(() => getSlotGetAllQueryOptions(params(),options?.()), queryClient) as CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
...
export const slotAvailable = async (availableSlotRequest: AvailableSlotRequest, options?: RequestInit): Promise<boolean> => {
...
export const getSlotAvailableMutationOptions = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof slotAvailable>>, TError,{data: BodyType<AvailableSlotRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const createSlotAvailable = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: () => { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof slotAvailable>>, TError,{data: BodyType<AvailableSlotRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
