...
export const register = async (userRegisterRequest: UserRegisterRequest, options?: RequestInit): Promise<void> => {
...
export const getRegisterMutationOptions = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof register>>, TError,{data: BodyType<UserRegisterRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
): CreateMutationOptions<Awaited<ReturnType<typeof register>>, TError,{data: BodyType<UserRegisterRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof register>>, {data: BodyType<UserRegisterRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const createRegister = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: () => { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof register>>, TError,{data: BodyType<UserRegisterRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient): CreateMutationResult<
...
export const getRefreshMutationOptions = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof refresh>>, TError,void, TContext>, request?: SecondParameter<typeof customInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const createRefresh = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: () => { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof refresh>>, TError,void, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient): CreateMutationResult<
...
export const getRefreshRevokeAllMutationOptions = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof refreshRevokeAll>>, TError,void, TContext>, request?: SecondParameter<typeof customInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RefreshRevokeAllMutationResult = NonNullable<Awaited<ReturnType<typeof refreshRevokeAll>>>

    export type RefreshRevokeAllMutationError = ErrorType<InternalErrorResponse>

    export const createRefreshRevokeAll = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: () => { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof refreshRevokeAll>>, TError,void, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient): CreateMutationResult<
        ...
        TContext
      > => {
      return createMutation(() => ({ ...getRefreshRevokeAllMutationOptions(options?.()) }), queryClient);
    }
...
export const refreshRevoke = async (refreshRevokeRequest: RefreshRevokeRequest, options?: RequestInit): Promise<void> => {
...
export const getRefreshRevokeMutationOptions = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof refreshRevoke>>, TError,{data: BodyType<RefreshRevokeRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
): CreateMutationOptions<Awaited<ReturnType<typeof refreshRevoke>>, TError,{data: BodyType<RefreshRevokeRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof refreshRevoke>>, {data: BodyType<RefreshRevokeRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const createRefreshRevoke = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: () => { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof refreshRevoke>>, TError,{data: BodyType<RefreshRevokeRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient): CreateMutationResult<
...
export const getRefreshListQueryKey = () => {
    return [
    `/account/refresh/list`
    ] as const;
    }


export const getRefreshListQueryOptions = <TData = Awaited<ReturnType<typeof refreshList>>, TError = ErrorType<InternalErrorResponse>>( options?: { query?:Partial<CreateQueryOptions<Awaited<ReturnType<typeof refreshList>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getRefreshListQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof refreshList>>> = ({ signal }) => refreshList({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof refreshList>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function createRefreshList<TData = Awaited<ReturnType<typeof refreshList>>, TError = ErrorType<InternalErrorResponse>>(
  options?: () => { query?:Partial<CreateQueryOptions<Awaited<ReturnType<typeof refreshList>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient
 ): CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {



  const query = createQuery(() => getRefreshListQueryOptions(options?.()), queryClient) as CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
...
export const passkey = async (passkeyRequest: PasskeyRequest, options?: RequestInit): Promise<string> => {
...
export const getPasskeyMutationOptions = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof passkey>>, TError,{data: BodyType<PasskeyRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
): CreateMutationOptions<Awaited<ReturnType<typeof passkey>>, TError,{data: BodyType<PasskeyRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof passkey>>, {data: BodyType<PasskeyRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const createPasskey = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: () => { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof passkey>>, TError,{data: BodyType<PasskeyRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient): CreateMutationResult<
...
export const getLogoutMutationOptions = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof logout>>, TError,void, TContext>, request?: SecondParameter<typeof customInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const createLogout = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: () => { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof logout>>, TError,void, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient): CreateMutationResult<
...
export const login = async (loginRequest: LoginRequest, options?: RequestInit): Promise<boolean> => {
...
export const getLoginMutationOptions = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof login>>, TError,{data: BodyType<LoginRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
): CreateMutationOptions<Awaited<ReturnType<typeof login>>, TError,{data: BodyType<LoginRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const createLogin = <TError = ErrorType<InternalErrorResponse>,
    TContext = unknown>(options?: () => { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof login>>, TError,{data: BodyType<LoginRequest>}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient): CreateMutationResult<
  ...
  return stringifiedParams.length > 0 ? `/account/login/google?${stringifiedParams}` : `/account/login/google`
}

export const loginGoogle = async (params: LoginGoogleParams, options?: RequestInit): Promise<void> => {
...
export const getLoginGoogleQueryKey = (params?: LoginGoogleParams,) => {
    return [
    `/account/login/google`, ...(params ? [params] : [])
    ] as const;
    }


export const getLoginGoogleQueryOptions = <TData = Awaited<ReturnType<typeof loginGoogle>>, TError = ErrorType<InternalErrorResponse>>(params: LoginGoogleParams, options?: { query?:Partial<CreateQueryOptions<Awaited<ReturnType<typeof loginGoogle>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getLoginGoogleQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof loginGoogle>>> = ({ signal }) => loginGoogle(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof loginGoogle>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function createLoginGoogle<TData = Awaited<ReturnType<typeof loginGoogle>>, TError = ErrorType<InternalErrorResponse>>(
 params: () =>  LoginGoogleParams, options?: () => { query?:Partial<CreateQueryOptions<Awaited<ReturnType<typeof loginGoogle>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: () => QueryClient
 ): CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {



  const query = createQuery(() => getLoginGoogleQueryOptions(params(),options?.()), queryClient) as CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
