...
export const accountRole = async (
	facilityId: number,
	options?: RequestInit
): Promise<UserRoleBasicDTO[]> => {
...
export const getAccountRoleQueryOptions = <
	TData = Awaited<ReturnType<typeof accountRole>>,
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof accountRole>>> = ({ signal }) =>
		accountRole(facilityId, { signal, ...requestOptions });
	...
	return {
		...
		...queryOptions,
	} as CreateQueryOptions<Awaited<ReturnType<typeof accountRole>>, TError, TData> & {
		queryKey: DataTag<QueryKey, TData, TError>;
	};
};
...
export function createAccountRole<
	TData = Awaited<ReturnType<typeof accountRole>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
>(
	facilityId: () => number,
	...
	const query = createQuery(
		() => getAccountRoleQueryOptions(facilityId(), options?.()),
		queryClient
	) as CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
...
export const accountCredential = async (
	options?: RequestInit
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof accountCredential>>> = ({ signal }) =>
		accountCredential({ signal, ...requestOptions });

	return { queryKey, queryFn, ...queryOptions } as CreateQueryOptions<
		Awaited<ReturnType<typeof accountCredential>>,
		TError,
		TData
	> & { queryKey: DataTag<QueryKey, TData, TError> };
};

export type AccountCredentialQueryResult = NonNullable<
	Awaited<ReturnType<typeof accountCredential>>
>;
export type AccountCredentialQueryError = ErrorType<void | InternalErrorResponse>;

export function createAccountCredential<
	TData = Awaited<ReturnType<typeof accountCredential>>,
	TError = ErrorType<void | InternalErrorResponse>,
>(
	options?: () => {
		query?: Partial<
			CreateQueryOptions<Awaited<ReturnType<typeof accountCredential>>, TError, TData>
		>;
		request?: SecondParameter<typeof customInstance>;
	},
	queryClient?: () => QueryClient
	...
	const query = createQuery(
		() => getAccountCredentialQueryOptions(options?.()),
		queryClient
	) as CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
...
export const getAccountCredentialDisableTokenMutationOptions = <
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
export type AccountCredentialDisableTokenMutationResult = NonNullable<
	Awaited<ReturnType<typeof accountCredentialDisableToken>>
>;

export type AccountCredentialDisableTokenMutationError = ErrorType<void | InternalErrorResponse>;

export const createAccountCredentialDisableToken = <
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(
	options?: () => {
...
> => {
	return createMutation(
		() => ({ ...getAccountCredentialDisableTokenMutationOptions(options?.()) }),
		queryClient
	);
};
...
export const getAccountCredentialDisableMutationOptions = <
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
export type AccountCredentialDisableMutationResult = NonNullable<
	Awaited<ReturnType<typeof accountCredentialDisable>>
>;
...
export const createAccountCredentialDisable = <
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(
	options?: () => {
...
> => {
	return createMutation(
		() => ({ ...getAccountCredentialDisableMutationOptions(options?.()) }),
		queryClient
	);
};
