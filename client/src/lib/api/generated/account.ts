...
export const accountSessionRevoke = async (accountSessionRevokeRequest: AccountSessionRevokeRequest, options?: Parameters<typeof customInstance>[1]): Promise<void> => {
...
export const accountCredentialDisable = async (credentialDisableRequest: CredentialDisableRequest, options?: Parameters<typeof customInstance>[1]): Promise<void> => {
