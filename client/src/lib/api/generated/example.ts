...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof example>>> = ({ signal }) =>
		example({ signal, ...requestOptions });
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof exampleVerify>>> = ({ signal }) =>
		exampleVerify(params, { signal, ...requestOptions });
