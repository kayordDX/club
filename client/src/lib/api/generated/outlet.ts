...
export const outletGetBasic = async (
	slug: string,
	options?: RequestInit
): Promise<OutletBasicDTO> => {
...
export const getOutletGetBasicQueryOptions = <
	TData = Awaited<ReturnType<typeof outletGetBasic>>,
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof outletGetBasic>>> = ({ signal }) =>
		outletGetBasic(slug, { signal, ...requestOptions });
	...
	return {
		...
		...queryOptions,
	} as CreateQueryOptions<Awaited<ReturnType<typeof outletGetBasic>>, TError, TData> & {
...
export function createOutletGetBasic<
	TData = Awaited<ReturnType<typeof outletGetBasic>>,
	TError = ErrorType<InternalErrorResponse>,
>(
	slug: () => string,
	...
	const query = createQuery(
		() => getOutletGetBasicQueryOptions(slug(), options?.()),
		queryClient
...
>(
	...
	return {
		...
		enabled: slug !== null && slug !== undefined,
		...queryOptions,
	} as CreateQueryOptions<Awaited<ReturnType<typeof outletGet>>, TError, TData> & {
		queryKey: DataTag<QueryKey, TData, TError>;
	};
};
...
>(
	...
	return {
		...
		enabled: slug !== null && slug !== undefined,
		...queryOptions,
	} as CreateQueryOptions<Awaited<ReturnType<typeof outletAdminGet>>, TError, TData> & {
		queryKey: DataTag<QueryKey, TData, TError>;
	};
};
